...
Tenants are also relevant for your mmesh authorization policy since they are usually associated to [security groups](/docs/mmesh/iam/authorization#security-groups).
...
Browse the [Tenants Administration](/docs/mmesh/administration/tenants) section to learn how to manage your tenants.
...
Browse the [Networks Administration](/docs/mmesh/administration/networks) section to learn how to manage your networks.
...
Every subnet has a [security policy](/docs/mmesh/networking/network-security#security-policies) attached.

This **security policy acts as a distributed firewall** protecting every node connected to the subnet.

You can browse the [network security](/docs/mmesh/networking/network-security) section to learn about security policies and how to increase the protection of your nodes.
